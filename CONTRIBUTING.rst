...
-----------------------------------
English and Russian are the primary languages of the qddate. All languages are pre-configured and manually added for speed optimization.
:class:`DateParser` has function `__matchPrefix` which filters patterns and minimizes date comparisons.
