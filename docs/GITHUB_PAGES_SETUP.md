...
This document describes how qddate documentation is deployed to GitHub Pages at
`https://ivbeg.github.io/qddate/`.

## Prerequisites

1. The repository `ivbeg/qddate`
...
The published site is available at `https://ivbeg.github.io/qddate/`.
...
- **404 errors**: Verify `baseUrl` in `docusaurus.config.js` is `/qddate/`
